...
> (smoke/ablação/full). O documento `ROTEIRO_IMPLEMENTACAO.md` detalha os tamanhos
> recomendados e o passo a passo.
...
> Plano experimental atual (escopo `heads_final`, 5 sementes, avaliação pareada,
> figuras e sinais geométricos): ver `PLANO_EXPERIMENTOS.md`.
