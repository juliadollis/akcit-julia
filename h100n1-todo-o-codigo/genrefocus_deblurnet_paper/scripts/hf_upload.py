...
def _resolve_file(args) -> Path:
    ...
    if args.config:
        ...
        # output_dir/<stage>/<stage>.safetensors (deblur.safetensors, bokeh.safetensors)
        return Path(cfg.runtime.output_dir) / args.stage / f"{args.stage}.safetensors"
...
def main() -> None:
    ...
    p.add_argument("--stage", default="deblur", choices=["deblur", "bokeh"], help="usado com --config: output_dir/<stage>/<stage>.safetensors")
