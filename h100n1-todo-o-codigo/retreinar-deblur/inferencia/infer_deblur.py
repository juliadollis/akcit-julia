...
---
    ...
    python3 inferencia/infer_deblur.py --lora pesos/deblurNet.safetensors -i foto.jpg -o out.png

    # nosso modelo main+cond, com o texto FORA do adapter (o que o treino fez)
    python3 inferencia/infer_deblur.py --lora nosso.safetensors -i foto.jpg -o out.png \
        --main-adapter deblurring --text-adapter none

    # varredura de guidance (experimento do C2)
    python3 inferencia/infer_deblur.py --lora nosso.safetensors --dataset akcit-pixel/DDPD \
...
from _bootstrap import token_hf  # configura sys.path no import
