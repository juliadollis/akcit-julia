...
| oficial (nycu-cplab) | medido | 0.1596 | 0.0844 | 0.6477 | 0.4428 | 63.4001 |
...
| oficial (nycu-cplab) | medido | 0.2397 | 0.1153 | 0.4987 | 0.3542 | 42.4681 |

## Protocolo de cada linha medida

### DPDD · oficial (nycu-cplab)
...
- peso: `deblurNet.safetensors` (463703368 bytes, sha256 `8d4c39604e028ce7…`)

### RealDOF · oficial (nycu-cplab)
