...
# Estes testes exercitam o dataloader REAL, que depende de numpy/torch. No
# login node e no CI essas libs nao existem; pular e melhor do que quebrar a
# coleta e esconder os outros testes.
np = pytest.importorskip("numpy", reason="dataloader precisa de numpy")
torch = pytest.importorskip("torch", reason="dataloader precisa de torch")
