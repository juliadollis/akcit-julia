...
def cupy_launch(strFunction, strKernel):
    # PATCH (avaliacao AKCIT): cupy.cuda.compile_with_cache foi REMOVIDO no
    # cupy 13. RawModule com backend nvrtc e a substituicao oficial e compila o
    # MESMO codigo CUDA, sem alterar o kernel nem a numerica do renderizador.
    return cupy.RawModule(code=strKernel, backend="nvrtc").get_function(strFunction)
# end
