...
| so rota c (a+c) [step 45000] | 0.1940 [0.1716, 0.2203] | 0.1315 | 0.9577 | +0.7392 | +0.0431 |
| so rota c (a+c) [step 30000] | 0.1948 [0.1724, 0.2215] | 0.1321 | 0.9588 | +0.7639 | +0.0423 |
| so rota c (a+c) | 0.1952 [0.1728, 0.2202] | 0.1316 | 0.9582 | +0.7296 | +0.0419 |
| so rota c (a+c) [step 10000] | 0.1994 [0.1847, 0.2127] | 0.1345 | 0.9585 | +0.9108 | +0.0377 |
| so rota c (a+c) [step 20000] | 0.2005 [0.1807, 0.2203] | 0.1366 | 0.9572 | +0.8814 | +0.0366 |
...
| so rota c (a+c) [step 10000] | 0.1346 [0.1256, 0.1438] | 0.0909 | 0.9796 | +0.8281 | +0.2241 |
...
| so rota c (a+c) [step 45000] | DISTS | 500 | 10 | +0.0007 | [-0.0227, +0.0173] | 0.8610 | a referencia |
| so rota c (a+c) | DISTS | 500 | 10 | +0.0008 | [-0.0192, +0.0151] | 0.8430 | a referencia |
| so rota c (a+c) [step 30000] | DISTS | 500 | 10 | +0.0012 | [-0.0182, +0.0153] | 0.8192 | a referencia |
| so rota c (a+c) [step 10000] | DISTS | 500 | 10 | +0.0037 | [-0.0129, +0.0171] | 0.5952 | a referencia |
| so rota c (a+c) [step 20000] | DISTS | 500 | 10 | +0.0057 | [-0.0138, +0.0197] | 0.5010 | a referencia |
...
| so rota c (a+c) [step 45000] | LPIPS | 500 | 10 | -0.0107 | [-0.0554, +0.0230] | 0.6586 | **o modelo** |
| so rota c (a+c) [step 30000] | LPIPS | 500 | 10 | -0.0099 | [-0.0476, +0.0178] | 0.6116 | **o modelo** |
| so rota c (a+c) | LPIPS | 500 | 10 | -0.0095 | [-0.0479, +0.0205] | 0.6422 | **o modelo** |
| so rota c (a+c) [step 10000] | LPIPS | 500 | 10 | -0.0053 | [-0.0383, +0.0202] | 0.7898 | **o modelo** |
| so rota c (a+c) [step 20000] | LPIPS | 500 | 10 | -0.0042 | [-0.0399, +0.0184] | 0.8108 | **o modelo** |
...
| so rota c (a+c) [step 10000] | DISTS | 217 | 217 | -0.0976 | [-0.1124, -0.0839] | 0.0000 | **o modelo** |
...
| so rota c (a+c) [step 10000] | LPIPS | 217 | 217 | -0.2107 | [-0.2374, -0.1854] | 0.0000 | **o modelo** |
